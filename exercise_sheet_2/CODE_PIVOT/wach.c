...
/*    fprintf(datei,"%d %.0lf %.0lf %g %g %g %g %g %g %g %g\n",
                zeit,data.alex_pol1,data.alex_pol2,data.bondangleA,
                data.bondlength1A,data.endA,
                data.gyrA,data.msdA,data.energy_ljA,
                data.energy_feneA,(data.px+data.py+data.pz)/3);
*/

    fprintf(datei,"%d %g %g %g %g\n",
                zeit,data.endA,
                data.gyrA,data.energy_ljA,
                data.energy_feneA);
