...
extern MYVEC     *posA, *pos_tempA, *poslatA,*posB, *pos_tempB, *poslatB;
...
double dummy;
   ...
   pos_tempA      = (MYVEC *) calloc(NMONOMAXA, sizeof(MYVEC));   /* only used in pivot.c */
   ...
   pos_tempB      = (MYVEC *) calloc(NMONOMAXB, sizeof(MYVEC));   /* only used in pivot.c */
